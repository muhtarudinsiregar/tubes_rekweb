<div class="col-md-8 col-md-offset-2">
	<div class="row">
		...
		<?php echo form_open('users/proses_edit/'.$edit->id, 'class="form-horizontal"','role="form"' ); ?>
		<!-- <form action="simpan_users" class="form-horizontal" method="post"> -->
		<div class="form-group">
			<label class="col-md-3 control-label" for="username">Username</label>
			<div class="col-md-6">
				<input class="form-control" type="text" name="username" value="<?php echo $edit->username; ?>">
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				<input class="form-control" type="password" name="password" value="<?php echo $edit->password; ?>"><?php echo form_error('password'); ?>
			</div>
		</div>
